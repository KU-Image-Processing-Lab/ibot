    ...
    if utils.get_rank() == 0:
        ...
        for lambd in args.lr_lambd:
            acc = logistic_regression(
                train_features, train_labels, test_features, test_labels, lambd, args
            )
...
def logistic_regression(
    ...
    classifier = ars.MultiClassifier(
        loss="multiclass-logistic", penalty="l2", fit_intercept=False
    )
    classifier.fit(
        train_features,
        train_labels,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=100,
        type=int,
        help="Training epochs of logistic regression.",
    )
